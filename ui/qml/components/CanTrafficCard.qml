    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                implicitHeight: 28
                radius: 8
                color: clearFiltersArea.pressed ? "#e8eff8" : (clearFiltersArea.containsMouse ? "#f1f6fd" : "#ffffff")
                border.color: clearFiltersArea.containsMouse ? "#a7bdd4" : "#cfdbe7"
                border.width: 1

                Text {
                    anchors.centerIn: parent
                    text: "Сброс фильтров"
                    color: clearFiltersArea.containsMouse ? "#334155" : "#51657a"
                    font.pixelSize: 11
                    font.bold: true
                    font.family: "Bahnschrift"
                }
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                FilterComboBox { id: dataFilter; Layout.fillWidth: true; popupMinWidth: 620; editable: true; model: root.optionsWithAny(root.appController ? root.appController.canFilterDataOptions : []); onActivated: root.applyFilterFromCombo("data", dataFilter); onEditTextChanged: root.applyFilter("data", root.comboValue(dataFilter)) }
            }
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                implicitHeight: 24
                radius: 7
                color: clearCanArea.pressed ? "#e8eff8" : (clearCanArea.containsMouse ? "#f1f6fd" : "#ffffff")
                border.color: clearCanArea.containsMouse ? "#a7bdd4" : "#cfdbe7"
                border.width: 1

                Text {
                    anchors.centerIn: parent
                    text: "Очистить CAN"
                    color: clearCanArea.containsMouse ? "#334155" : "#51657a"
                    font.pixelSize: 10
                    font.bold: true
                    font.family: "Bahnschrift"
                }
